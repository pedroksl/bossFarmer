...
class MainWindow(QMainWindow):
    ...
    def updateTable(self):
        ...
        self.ui.tableWidget.setItem(1,4, QTableWidgetItem("Cell (1,1)"))
        self.ui.tableWidget.setItem(1,5, QTableWidgetItem("Cell (1,2)"))
        self.ui.tableWidget.setItem(1,6, QTableWidgetItem("Cell (2,1)"))
        self.ui.tableWidget.setItem(1,7, QTableWidgetItem("Cell (2,2)"))
        self.ui.tableWidget.setItem(2,0, QTableWidgetItem("Cell (3,1)"))
        self.ui.tableWidget.setItem(2,1, QTableWidgetItem("Cell (3,2)"))
        self.ui.tableWidget.setItem(2,2, QTableWidgetItem("Cell (4,1)"))
        self.ui.tableWidget.setItem(2,3, QTableWidgetItem("Cell (4,2)"))
        self.ui.tableWidget.setItem(2,4, QTableWidgetItem("Cell (3,1)"))
        self.ui.tableWidget.setItem(2,5, QTableWidgetItem("Cell (3,2)"))
        self.ui.tableWidget.setItem(2,6, QTableWidgetItem("Cell (4,1)"))
        self.ui.tableWidget.setItem(2,7, QTableWidgetItem("Cell (4,2)"))
        self.ui.tableWidget.setItem(3,0, QTableWidgetItem("Cell (1,1)"))
        self.ui.tableWidget.setItem(3,1, QTableWidgetItem("Cell (1,2)"))
        self.ui.tableWidget.setItem(3,2, QTableWidgetItem("Cell (2,1)"))
        self.ui.tableWidget.setItem(3,3, QTableWidgetItem("Cell (2,2)"))
        self.ui.tableWidget.setItem(3,4, QTableWidgetItem("Cell (1,1)"))
        self.ui.tableWidget.setItem(3,5, QTableWidgetItem("Cell (1,2)"))
        self.ui.tableWidget.setItem(3,6, QTableWidgetItem("Cell (2,1)"))
        self.ui.tableWidget.setItem(3,7, QTableWidgetItem("Cell (2,2)"))
